...
import { SubmitBookingDetails } from "../../types/roomType";
...
export default function RoomDetails() {
  ...
  if (id) {
    ...
    if (queryData) {
      return (
        <div className="w-full mx-auto border-2 border-pink-900 font-roboto">
          <h1 className="my-4 text-2xl font-bold text-center lg:mx-6 lg:text-start">
          ...
          <div className="lg:flex lg:gap-4">
            <div>
              <img
                ...
                className="mx-auto overflow-hidden max-h-80 max-w-80 lg:ml-6 lg:max-h-96 lg:max-w-96"
              />
            </div>
            <div className="flex-col lg:ml-10">
              <div className="pb-4 mx-6 ">
                <p className="my-4 text-xl font-bold text-center text-gray-700 underline lg:text-start">
                  Room Details
                </p>
                <div className="lg:flex lg:flex-grow">
                  <div className="lg:w-72 lg:flex-col">
                    ...
                    <p className="mb-10 text-base text-center text-gray-500 lg:mb-6 lg:px-10 lg:text-start">
                  ...
                  <div className="lg:flex-col">
                    <div className="flex justify-center my-2 lg:my-4 lg:justify-start">
                      ...
                      <p className="px-4 mb-4 text-base font-bold lg:mb-2">
                        Equipments
                      </p>
                    </div>
                    {queryData.room.equipment.length ? (
                      <div className="px-24 mb-10 lg:flex lg:gap-x-4 lg:px-10 ">
                        {queryData.room.equipment.map((equipment) => (
                          <div
                            className="px-2 py-1 mb-6 text-sm text-center text-gray-500 border rounded-md"
                            key={equipment}
                          >
                            {equipment}
                          </div>
                      ...
                      <div className="mb-10 text-base text-center text-gray-500 lg:mb-6 lg:px-10 lg:text-start">
                        None
                      </div>
                    )}
                  </div>
              ...
              <div className="pb-4 mx-6 ">
                ...
                <div className="lg:flex lg:flex-grow ">
                  <div className="lg:flex-col">
                    ...
                    <p className="mb-10 text-base text-center text-gray-500 lg:mb-6 lg:w-72 lg:px-10 lg:text-start">
          ...
          <div className="p-5 mx-2 border-2 border-gray-200 border-dotted lg:mx-6">
            <h3 className="font-bold text-gray-500">Terms and conditions:</h3>
            <ul className="block py-1 text-xs text-gray-400 list-none lg:text-sm">
              <li className="py-1">
          ...
          {mutationIsSuccess && (
            <div className="flex justify-center my-10 ">
              <div className="text-center">
                ...
                <div>
                  <p className="mb-2 text-base text-gray-500 pi pi-hashtag"></p>{" "}
                  <span className="text-gray-500">{mutationData && mutationData._id}</span>
                </div>
                <button
                  className="p-1 mx-1 text-sm text-gray-700 border hover:scale-125"
                  onClick={() => navigate("/services/rooms")}
                >
                  Return
                </button>
