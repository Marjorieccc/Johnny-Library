...
export default function PageNavigate({ resources: { setPageNumber, setStartPageNumber,setEndPageNumber,startPageNumber,endPageNumber,totalPages, startIndex, endIndex, totalItems } }: { resources: pageProps }){
