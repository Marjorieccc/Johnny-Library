...
export default function PageNavigate({
  ...
  const displayPageList = allPagesList.slice(
    startPageNumber - 1,
    endPageNumber
      ...
      <div className="sm:flex sm:justify-center ">
        ...
        {displayPageList?.map((pageNumber) => (
          <button
            ...
            style={{
              fontWeight: selectPage.current === pageNumber ? "bold" : "normal",
            }}
          >
            {pageNumber}
          </button>
        ...
        <button
          onClick={() => handleChange(pageInterval)}
          disabled={endPageNumber > totalPages}
        >
          <span
            className="pi pi-angle-right"
            style={{
              color: endPageNumber > totalPages ? "#c6c6c6" : "#222222",
            }}
          ></span>
        </button>
