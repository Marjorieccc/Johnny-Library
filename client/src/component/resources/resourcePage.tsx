    ...
    return(
        <div className="ml-4 lg:ml-40 px-20">
            ...
            <button onClick={()=>backToStart()} disabled={startPageNumber === 1}>
                <i className="pi pi-step-backward " style={{ color: startPageNumber === 1 ? 'white' : '#c6c6c6' }}></i>
            </button>
            ...
            <button onClick={() => handleChange(-pageInterval)} disabled={startPageNumber === 1}>
                <i className="pi pi-chevron-left ml-4 mr-4 " style={{ color: startPageNumber === 1 ? 'white' : '#c6c6c6' }}></i>
            </button>
            ...
            <button onClick={() => handleChange(pageInterval)} disabled={endPageNumber > totalPages}>
                <i className="pi pi-chevron-right ml-4 mr-4" style={{ color: endPageNumber > totalPages ? 'white' : '#c6c6c6' }}></i>
            </button>
            ...
            <button onClick={()=>goToEnd()}  disabled={endPageNumber > totalPages}>
                <i className="pi pi-step-forward " style={{ color: endPageNumber > totalPages ? 'white' : '#c6c6c6' }}></i>
            </button>
